import {WidgetConfig} from '../../../../config/pathways-and-recommendations'
import {PathwaysAndRecommendationsMapper} from '../mapper'
...
test('PathwaysAndRecommendations mapper builds the correct data object from non-empty v2 API response', () => {
      ...
      docs: [
        {
          ...
          thumb_image:
            'https://pacific-demo-data.bloomreach.cloud/home/images/83554_XXX_v1.tif',
          pid: '83554',
          sale_price: 12.26,
          price: 18.86,
  ...
  expect(
    PathwaysAndRecommendationsMapper.buildFromV2Response(apiResponse, config)
