...
import {ProductSearchMapper} from '../mapper'

test('ProductSearch mapper builds the correct data object from non-empty v2 API response', () => {
  const apiResponse = {
    response: {
      numFound: 9,
      start: 0,
  ...
  expect(ProductSearchMapper.buildFromV2Response(apiResponse, config))
...
test('ProductSearch mapper builds the correct data object from empty v2 API response', () => {
  const apiResponse = {
    response: {
      numFound: 0,
      start: 0,
...
test('ProductSearch mapper builds the correct data object from v2 API response when the Display Variants setting is on', () => {
  const apiResponse = {
    response: {
      numFound: 2,
      start: 0,
