...
import {PathwaysAndRecommendationsConfigFactory} from '../pathways-and-recommendations'
...
test('it builds the correct Item widget config object', () => {
  ...
  mocked(buildStaticWidgetConfigParameters).mockReturnValue({
  ...
  expect(buildStaticWidgetConfigParameters).toHaveBeenCalledTimes(1)
