...
test('it builds the correct config object for Category module', () => {
    utils_1.mocked(common_1.buildStaticCategoryConfigParameters).mockReturnValue({
    ...
    const categoryConfig = category_1.CategoryConfig.build({
        q: 'valid product search query'
    });
    expect(common_1.buildStaticCategoryConfigParameters).toHaveBeenCalledTimes(1);
